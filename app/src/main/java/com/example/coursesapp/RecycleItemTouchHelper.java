...
public abstract class RecycleItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    private synchronized void recouverSwipedItem() {
    ...
    public RecycleItemTouchHelper(Context context,RecyclerView recyclerView,int buttonWidth) {
